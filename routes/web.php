...
Route::group(['middleware' => ['direktur']], function () {
  ...
  Route::get('/api/direktur/listmentor',"ApiControl@listmentor")->name("private.api.listmentor");
...
Route::group(['middleware' => ['gerai']], function () {
  Route::get('/gerai',"GeraiControl@index")->name('gerai.home');
  Route::get('/gerai/barang',"GeraiControl@barang")->name('gerai.barang');
  Route::get('/gerai/keuangan',"GeraiControl@keuangan")->name('gerai.keuangan');
  Route::get('/gerai/lapbarang',"GeraiControl@laporanbarang")->name('gerai.lapbarang');
  Route::get('/gerai/lappesanan',"GeraiControl@laporanpesanan")->name('gerai.lappesanan');
...
Route::group(['middleware' => ['mentor']], function () {
  ...
  // bagihasil_print
  Route::get('/mentor/franchise/bagihasil_print/{id}',"MentorControl@bagihasil_print")->name('mentor.franchise.bagihasil_print');
  Route::get('/mentor/franchise/setlokasi/{id}',"MentorControl@franchise_setlokasi")->name('mentor.franchise.setlokasi');
  ...
  Route::get('/mentor/lappesanan/{id?}',"MentorControl@laporanpesanan")->name('mentor.lappesanan');
